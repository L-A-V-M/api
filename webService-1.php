...
curl_setopt_array($curl, [
	CURLOPT_URL => "https://shazam.p.rapidapi.com/auto-complete?term".$canc,
...
<head>
    ...
    <title>web service RESTful</title>
</head>
<body  >
    <style>
        body{
    ...
    <center>
        <div>
            <form action="" method="GET">
                <h3 id="titulo">Nombre de la cancion:</h3><br>
        ...
        <table width="300">
            <tr>
                <td><h2>Resultados obtenidos</h2></td>
            </tr>
            <?php
